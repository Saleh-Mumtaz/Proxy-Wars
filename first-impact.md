...
جرقه این نوشته با دیدن این ترجمه [seakfind](https://github.com/seakfind/examples/blob/main/xtls-vision/README.md) زده شد، و وقتی ترجمه گوگل در ۲۰۲۲ و چت جی‌پی‌تی در ۲۰۲۴( آن هم ترجمه به پارسی!) را میبینم، متوجه پیشرفت بسیار خوب هوش مصنوعی می‌شوم.
