...
**به زودی روی vsion seed توسط rprx کار خواهد شد،(اگر بجای اتلاف وقت روی کل انداختن با پنل ثنایی روی اون متمرکز میشد الان سه نسخه تو رفع باگش میبودیم) آن موقع که امد در هسته و تو پنل هم مهندس ثنایی اعلام کرد امده، حتما حتما برید xtls.github.io و ببینید چطور باید تنظیمش کرد. یک سری مشخصه های دیگه اضافه میکنه که برای فرایندهای تصادفی seed اولیه از کاربر گرفته بشه.**
