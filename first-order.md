...
(من فکر میکنم نحوه تشخیص اینکه سرور ما به اون sni استفاده شده ارتباطی نداره رو نمیتونه به وسیله اینکه خودش بیاد پینگ کنه و ببیند تو asn اون هستیم یا نه انجام بده، اینکار غیرممکن هست، اول از همه گوگل Google LLC  [هشت میلیون](https://ipinfo.io/AS15169) ایپی داره، چطور میخواد بفهمه کدام ایپی رو چک کنم پینگ کنم خب گیریم پینگ کرد ایپی ها همخوانی نداشت، گوگل ایپی بسیار زیاد داره. میخواد هرچه همخوانی نداشت ببنده؟ حل این مشکل شاید این باشه بیاد برای این دامنه ها، دی ان اس داخل کشور رو دستکار کند یک سری ایپی مشخص تعریف کند، خارج از این بازه را چک کند، مشکل بعدی این است که مگر گوگل فقط یک سایت هست؟ سرویس های بسیار متنوعی داره) <br />
