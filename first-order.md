...
ستاپ اشتباه بود، ریلیتی پورت ۸۴۴۳ و سایت ۴۴۳. همچنین احتمال دخالت گزارشگران ایپی به کمک یک نرم افزاری مثل وایرشارک ولی برای اندروید هم بود. یا حتی اجرای مهساانجی روی بلواستک و استفاده از همان وایرشارک. چرا این حرف رو میزنم؟ این هست که روی همون سرور بالا من ستاپ اشتباه رو پیاده کردم، ۱۵۰ گیگابایت ازش رد شد، همه روی همراه اول.
