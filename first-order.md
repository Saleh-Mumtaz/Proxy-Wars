...
**یک نکته** از سازنده ایکس‌ری رو دیدم که بد نیست اینجا هم بگم: هدف ساخت وی‌پی‌ان مبتنی بر tls این هست که ترافیک ما کاربران و سرورمون به طور کامل شبیه به بازدید از یک سایت https عادی باشه.
