...
دوستان پرسیده بودن چرا ریلیتی رو نمیشه پشت سی دی ان انداخت، علتش استفاده از tcp هست، سی دی ان میخواد محتوا رو کش کنه لاکن ما میخواهیم در لحظه همه چیز به سرور برسه. برای همین در اینباندهای سی دی ان از ws و grpc یا split استفاده میشه. در نظر داشته باشید اخرین بار که گیتهاب هسته رو دیدم نوشته بود ویژن برای اسپلیت هم امده، اگر تونستید ان رو امتحان کنید، مشکل ما با سی دی ان خارجی اون تشخیص tls-in-tls و گاهی utls بود(مگر اینکه http خالی باشه)، من خودم روی یک دامنه ۷۵۰ گیگ با کلاودفلر عبور دادم بعدش طوری شد سایت بالا می‌امد ولی وی پی ان وصل نمیشد، فقط اتصال مرورگر واقعی جواب میداد.(راه حلش browser dialer هست، 2dust گفت علاقه ای به اجراش نداره سخته براش) البته که بعدا روش همین ریلیتی رو اجرا کردم و بدون مشکلی کار کرد. 
